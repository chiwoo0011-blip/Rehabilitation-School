...
const AttendancePlaceholder = () => (
    <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: COLORS.background }}>
        ...
        <Text style={{ fontSize: 18, fontWeight: 'bold', marginTop: 16, color: COLORS.textPrimary }}>오늘 등교 완료</Text>
        <Text style={{ color: COLORS.textSecondary, marginTop: 8 }}>08:45 담임 선생님 확인</Text>
    </View>
);
...
const HomeStack = () => (
    ...
    >
        ...
        <Stack.Screen name="Attendance" component={AttendancePlaceholder} options={{ title: '등하교 확인 ✅' }} />
