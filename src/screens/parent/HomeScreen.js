    ...
    return (
        <SafeAreaView style={styles.safe} edges={['top']}>
            ...
            >
                ...
                <TouchableOpacity style={styles.homepageBtn} onPress={openHomepage} activeOpacity={0.85}>
                    <View style={styles.homepageIcon}>
                        <Ionicons name="globe-outline" size={20} color="#fff" />
                    </View>
                    <View style={{ flex: 1 }}>
                        <Text style={styles.homepageLabel}>학교 홈페이지</Text>
                        <Text style={styles.homepageSub} numberOfLines={1}>{APP_CONFIG.homepageUrl}</Text>
                    </View>
